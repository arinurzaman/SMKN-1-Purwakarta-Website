...
<form action="{{ url('admin/kategoriprestasi/tambah') }}" method="post" accept-charset="utf-8">
{{ csrf_field() }}

<div class="form-group row">
	<label class="col-md-3">Nama Kategori</label>
	<div class="col-md-9">
		<input type="text" name="nama_prestasi" class="form-control" placeholder="Nama kategori prestasi" value="" required>
		@if ($errors->has('nama_prestasi'))
	      	<span class="text-danger">{{ $errors->first('nama_prestasi') }}</span>
	    @endif  
	</div>
</div>
