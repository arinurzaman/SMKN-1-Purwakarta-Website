...
<!--Page Wrapper -->
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      {{-- Profil --}}
      <li class="nav-item">
        <a class="nav-link" href="{{ asset('admin/profil') }}">
          <i class="fas fa-school"></i> <span>Profil</span></a>
      </li>
      <!-- Berita -->
      <li class="nav-item">
      ...
      {{-- Prestasi --}}
      <li class="nav-item">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#prestasi" aria-expanded="true" aria-controls="prestasi') }}">
          <i class="fas fa-trophy"></i>
          <span>Prestasi</span>
        </a>
        <div id="prestasi" class="collapse" aria-labelledby="berita" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <a class="collapse-item" href="{{ asset('admin/prestasi') }}"><i class="fa fa-newspaper"></i> Data Prestasi</a>
            <a class="collapse-item" href="{{ asset('admin/prestasi/tambah') }}"><i class="fa fa-plus"></i> Tambah Prestasi</a>
            <a class="collapse-item" href="{{ asset('admin/kategoriprestasi') }}"><i class="fa fa-tags"></i> Kategori Prestasi</a>
          </div>
        </div>
      </li>
      {{-- Jurusan --}}
      <li class="nav-item">
        <a class="nav-link" href="{{ asset('admin/jurusan') }}">
          <i class="fas fa-university"></i> <span> Jurusan</span></a>
      </li>
      {{-- Industri Pasangan --}}
      <li class="nav-item">
        <a class="nav-link" href="{{ asset('admin/industri') }}">
          <i class="fas fa-building"></i> <span> Industri Pasangan</span></a>
      </li>
      <!-- Download -->
      <li class="nav-item">
