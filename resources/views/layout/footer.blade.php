...
<script>
  ...
  <footer id="footer">
        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6 footer-links">
            ...
            <ul>
              ...
              <li><i class="bx bx-chevron-right"></i> <a href="{{ asset('berita') }}">Info Nepoer</a></li>
              <li><i class="bx bx-chevron-right"></i> <a href="{{ asset('profil') }}">Profil</a></li>
              <li><i class="bx bx-chevron-right"></i> <a href="{{ asset('jurusan') }}">Kompetensi Keahlian</a></li>
              <li><i class="bx bx-chevron-right"></i> <a href="{{ asset('galeri') }}">Gallery</a></li>
          ...
          <div class="col-lg-4 col-md-6 footer-newsletter">
            ...
            <p>
              ...
              <br><br><?php echo nl2br($site->alamat) ?>
              <br><br>Email: <?php echo $site->email ?>
    ...
    <div class="container">
      ...
      <div class="credits">
        Developed by <a href="#">Philosophycode</a>
      </div>
    </div>
  </footer><!-- End Footer -->
