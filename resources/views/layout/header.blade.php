    ...
    <div class="container d-flex align-items-center">
      ...
      <nav class="nav-menu d-none d-lg-block">
        <ul>
            ...
            <li><a href="{{ asset('berita') }}">Info Nepoer</a></li>
            <li><a href="{{ asset('profil') }}">Profil</a>
              <ul>
            ...
            {{-- <li class="drop-down"><a href="{{ asset('produk') }}">Bidang</a>
              <ul>
            ...
            <li><a href="{{ asset('jurusan') }}">Komp. Keahlian</a>
            </li>
